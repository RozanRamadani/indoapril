                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Barang #{{ str_pad($barang->idbarang, 4, '0', STR_PAD_LEFT) }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Anda sedang mengedit barang <strong>{{ $barang->nama }}</strong>. Pastikan semua perubahan sudah benar sebelum menyimpan.
                        </p>
                    </div>
                </div>
            </div>
